 ...
 * This file demonstrates how to integrate Cryptomatrix with a web frontend
 */

// For React/Vue/Angular applications
export class CryptomatrixClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new CryptomatrixClient(provider, contractAddress);
