...
const contractABI = require("../artifacts/contracts/Cryptomatrix.sol/Cryptomatrix.json").abi;

program
    .name("cryptomatrix-cli")
    .description("CLI tool for Cryptomatrix smart contract")
    .version("1.0.0");
